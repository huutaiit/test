...
public class BadgeImpl {
     ...
     */
    public void getBadge (CallbackContext callback, Context ctx) {
    ...
    public  int getBadge2 ( Context ctx) {
        SharedPreferences settings = getSharedPreferences(ctx);
        int badge = settings.getInt(KEY, 0);
       return badge;
    }
     ...
     * The application context
     */
    public void setBadge (JSONArray args, Context ctx) {
     ...
     * The application context.
     */
    public void saveBadge (int badge, Context ctx) {
     ...
     * The function to be exec as the callback
     */
    public void hasPermission (final CallbackContext callback) {
