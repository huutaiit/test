App.registerCtrl('myPayroll', function ($scope, $rootScope, ProcessService, $location) {
  ...
  $scope.listMenuPayroll = [
    ...
    {
      id: 693,
      href: "payrollAppendix8A",
      icon: "pro682.png",
      name: "Appendix8A",
      description: $rootScope.lang.mypayroll.appendix8A.ct
    },
    {
      id: 694,
      href: "payrollAppendix8B",
      icon: "pro682.png",
      name: "Appendix8B",
      description: $rootScope.lang.mypayroll.appendix8B.ct
    },
    {id: 1611, href: "payrollTaxExemption", icon: "pro682.png", name: "Tax Exemption", description: $rootScope.lang.mypayroll.taxExemption.ct},
  ]
  $scope.month = [
  ...
  var processPayrollIR8A = function () {


    ProcessService.ajaxGet("MyPayrollIR8A/GetListIR8A")
      .then(function (result) {
        $scope.objData = JSON.parse(result.data);
        console.log($scope.objData);
        var checkHaveData = $scope.objData.CheckHaveData;
  ...
  var processPayrollIR8S = function () {


    ProcessService.ajaxGet("MyPayrollIR8S/GetListIR8S")
      .then(function (result) {
        $scope.objData = JSON.parse(result.data);
        console.log($scope.objData);
        var checkHaveData = $scope.objData.CheckHaveData;
  ...
  var processPayrollAppendix8A = function () {


    ProcessService.ajaxGet("MyPayrollAppendix8A/GetListAppendix8A")
      .then(function (result) {
        $scope.objData = JSON.parse(result.data);
        console.log($scope.objData);
        var checkHaveData = $scope.objData.CheckHaveData;
  ...
  var processPayrollAppendix8B = function () {


    ProcessService.ajaxGet("MyPayrollAppendix8B/GetListAppendix8B")
      .then(function (result) {
        $scope.objData = JSON.parse(result.data);
        console.log($scope.objData);
        var checkHaveData = $scope.objData.CheckHaveData;
  ...
  var processPayrollTaxExemption = function () {


    ProcessService.ajaxGet("MyPayrollTaxExemption/GetListTaxExemption")
      .then(function (result) {
        $scope.objData = JSON.parse(result.data);
        console.log($scope.objData);
        var checkHaveData = $scope.objData.CheckHaveData;
  ...
  switch ($location.path()) {
    ...
    case "/payrollTaxExemption":
      processPayrollTaxExemption();
      break;
  }
});
